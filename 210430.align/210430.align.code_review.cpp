...
public:
    ...
    3DVector(const S& v1, const S& v2, const S& v3)		// missing constructor (for ex. from 3 `T` arguments)
    {									// better variable names possible (for ex. use x, y, z instead of v1, v2, v3)
